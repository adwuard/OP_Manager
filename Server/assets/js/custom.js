$(document).ready(function(){
    ...
    $('#filer_input').filer({
        ...
        templates: {
            ...
            item: '<li class="jFiler-item"><div class="jFiler-item-container">' +
                ...
                '<div class="jFiler-item-title" title="{{fi-name}}">{{fi-name | limitTo:30}}</div>' +
                '<div class="jFiler-item-others"><span>size: {{fi-size2}}</span>' +
            ...
            itemAppend: '<li class="jFiler-item">' +
                ...
                '<div class="jFiler-item-others"><span>size: {{fi-size2}}</span>' +
                '<span>type: {{fi-extension}}</span>' +
                '<span class="jFiler-item-status"></span></div></div></div></div></li>',
    ...
    $('#close-create-folder').click(function() {
        $('#filer_input').prop("jFiler").reset()
    });

    $('#del-file').click(function() {
        // alert( "Handler for .click() called." );
        console.log("Pressed"+"{{fi-name}}");
    });
